<div class="o-page__sidebar js-page-sidebar">
    <div class="c-sidebar">
        <a class="c-sidebar__brand">
            <img class="c-sidebar__brand-img" src="http://xsodia.space/payroll/assets/logo.png" alt="Logo"
        ...
        <ul class="c-sidebar__list">
            ...
            <li class="c-sidebar__item has-submenu ">
                <a class="c-sidebar__link" data-toggle="collapse" href="#sidebar-submenu" aria-expanded="true"
            ...
            <li class="c-sidebar__item has-submenu ">
                <a class="c-sidebar__link" data-toggle="collapse" href="#sidebar-submenu_3" aria-expanded="false"
                    aria-controls="sidebar-submenu_3">
                    <i class="fa fa-street-view u-mr-xsmall"></i> Employees
                </a>
                <ul class="c-sidebar__submenu collapse" id="sidebar-submenu_3">
                    <li><a class="c-sidebar__link" href="{{ URL::route('employee') }}">Records</a></li>
                    <li><a class="c-sidebar__link" href="{{ URL::route('employee.create') }}">Add new</a></li>

                </ul>
            </li>
            <li class="c-sidebar__item has-submenu ">
                <a class="c-sidebar__link" data-toggle="collapse" href="#sidebar-submenu_4" aria-expanded="false"
                    aria-controls="sidebar-submenu_4">
                ...
                <ul class="c-sidebar__submenu collapse" id="sidebar-submenu_4">
                    ...
                    <li><a class="c-sidebar__link" href="http://xsodia.space/payroll/loans/types/add">Add Loan Types</a>
                    </li>

                </ul>
            </li>
            <li class="c-sidebar__item has-submenu ">
                <a class="c-sidebar__link" data-toggle="collapse" href="#sidebar-submenu_5" aria-expanded="false"
                    aria-controls="sidebar-submenu_5">
                ...
                <ul class="c-sidebar__submenu collapse" id="sidebar-submenu_5">
                    ...
                    <li><a class="c-sidebar__link" href="http://xsodia.space/payroll/leaves/types/add">Add Leaves
                            Types</a></li>

                </ul>
            </li>
            <li class="c-sidebar__item has-submenu ">
                <a class="c-sidebar__link" data-toggle="collapse" href="#sidebar-submenu_6" aria-expanded="false"
                    aria-controls="sidebar-submenu_6">
                ...
                <ul class="c-sidebar__submenu collapse" id="sidebar-submenu_6">
                    ...
                    <li><a class="c-sidebar__link" href="http://xsodia.space/payroll/deductions/view/tax">Tax Table</a>
                    </li>
                    <li><a class="c-sidebar__link" href="http://xsodia.space/payroll/deductions/view/sss">SSS Table</a>
                    </li>
                    <li><a class="c-sidebar__link"
                            href="http://xsodia.space/payroll/deductions/view/philhealth">Philhealth Table</a></li>
                    <li><a class="c-sidebar__link" href="http://xsodia.space/payroll/deductions/view/pagibig">Pagibig
                            Table</a></li>

                </ul>
            </li>
            <li class="c-sidebar__item has-submenu ">
                <a class="c-sidebar__link" data-toggle="collapse" href="#sidebar-submenu_7" aria-expanded="false"
                    aria-controls="sidebar-submenu_7">
            ...
            <li class="c-sidebar__item has-submenu ">
                <a class="c-sidebar__link" data-toggle="collapse" href="#sidebar-submenu_8" aria-expanded="false"
                    aria-controls="sidebar-submenu_8">
                ...
                <ul class="c-sidebar__submenu collapse" id="sidebar-submenu_8">
                    ...
                    <li><a class="c-sidebar__link" href="http://xsodia.space/payroll/payslips/process">Process
                            Payroll</a></li>

                </ul>
            </li>
            <li class="c-sidebar__item has-submenu ">
                <a class="c-sidebar__link" data-toggle="collapse" href="#sidebar-submenu_9" aria-expanded="false"
                    aria-controls="sidebar-submenu_9">
