    ...
    <div class="container-fluid" style="margin:1%; padding:1%; width:98%; margin-top: 2%; background-color: white;">
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12" style="padding: 2%;"> 
                <form method="post" action="{{ URL::route('loantype.Save',$data->id) }}"> 
                    @csrf
                    <div class="row"> 
                        <div class="col-sm-4 col-md-4 u-mb-medium">
                            <div class="c-form-field">
                                <label class="c-field__label" for="input17">Loan Type Name</label>
                        ...
                        <div class="col-sm-4 col-md-4 u-mb-medium">
                            <div class="c-form-field">
                                ...
                                <input class="c-input c-input--info" id="input17" type="text" required name="description" value="{{ $data->description }}">
                            </div>
                        </div> 
